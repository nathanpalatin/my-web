...
hoverChangeDescription(
  ".styled",
  "React Native é um framework de desenvolvimento mobile que permite criar aplicativos nativos usando JavaScript e React. Desenvolvido pelo Facebook, ele permite que você escreva um código único que é traduzido para componentes nativos em iOS e Android, resultando em uma experiência próxima a um aplicativo nativo em termos de desempenho e interface."
);
hoverChangeDescription(
  ".tailwind",
...
hoverChangeDescription(
  ".radix",
  "Node.js é uma plataforma de desenvolvimento de software que permite executar JavaScript no lado do servidor. Baseado no motor V8 do Google Chrome, ele é conhecido por ser eficiente e escalável, utilizando um modelo de eventos assíncronos e de I/O não-bloqueante."
);
hoverChangeDescription(
  ".cypress",
